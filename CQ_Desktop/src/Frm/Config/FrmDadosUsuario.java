 ...
 * @author rafael.lopes
 */
public class FrmDadosUsuario extends javax.swing.JDialog {
     ...
     * @param user
     */
    public FrmDadosUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FrmDadosUsuario(java.awt.Frame parent, boolean modal, Usuario user) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Dados do Usuário");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDadosUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDadosUsuario dialog = new FrmDadosUsuario(new javax.swing.JFrame(), true, null);
    ...
    private void criarUsuario() {
        ...
        try {
            ...
            user.setPass(("").equals(Arrays.toString(txtNovaSenha.getPassword()))
                    ...
                    : Cript.md5("123456"));
            user.setName(txtNome.getText().trim().toUpperCase());
            user.setEmail(txtEmail.getText().toLowerCase());
            user.setLock((Integer) cmbStatus.getSelectedIndex() == 1);
            grup.setGroup_id(ComboBox.getKeyForValue(cmbGrupo.getSelectedItem().toString(), categoryMapGrupo));
            user.setGrupo(grup);
    ...
    private void carregarDados() {
        UsuarioDAO userDao = new UsuarioDAO();
        userDao.selectUser(usuario);
        txtUsuario.setText(usuario.getUser().toLowerCase());
        txtNome.setText(usuario.getName());
        txtEmail.setText(usuario.getEmail());
        cmbStatus.setSelectedIndex(usuario.getLock() ? 1 : 0);
        txtCracha.setText(usuario.getCracha());
        ckbAlterarSenha.setSelected((Boolean) usuario.getChange_pass());
        String[] turno = {usuario.getTurno()};
        cmbTurno.setSelectedItem(turno[0]);
        String[] grupo = {usuario.getGrupo().getGroup_name()};
        cmbGrupo.setSelectedItem(grupo[0]);
        String[] setor = {usuario.getSetor().getSigla_setor()};
    ...
    private void atulizarUsuario() {
        ...
        Setor setor = new Setor();
        try {
            usuario.setUser(txtUsuario.getText().toLowerCase());
            usuario.setName(txtNome.getText().toUpperCase());
            ...
            if (!new String(txtNovaSenha.getPassword()).trim().isEmpty()) {
                if (!new String(txtNovaSenha.getPassword()).equals(new String(txtConfirmaSenha.getPassword()))) {
                    ...
                    usuario.setPass(Cript.md5(new String(txtNovaSenha.getPassword())));
    ...
    public final void readGrupo() {
        ...
        for (Grupo grup : grupDao.readGrupo()) {
            Integer id = grup.getGroup_id();
            String name = grup.getGroup_name();
