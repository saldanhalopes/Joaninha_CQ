...
import Classes.Acesso.ConfigUsuarioAcesso;
...
public class FrmConfigUsuario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnOnline.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_on_line.png"))); // NOI18N
        ...
        tblUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Usuário", "Turno", "Setor", "Nome Completo", "Grupo", "Falhas de Login", "Bloqueado", "Último Login", "Online"
            }
        ) {
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            user.setUser_id((Integer) tblUsuarios.getValueAt(tblUsuarios.getSelectedRow(), 0));
            FrmDadosUsuario frm = new FrmDadosUsuario(null, true, user);
            frm.setVisible(true);
            readUsuarios();
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        FrmDadosUsuario frm = new FrmDadosUsuario(null, true);
        frm.setVisible(true);
        readUsuarios();
    ...
    public final void readUsuarios() {
        ...
        model.setNumRows(0);
        for (Usuario user : userDao.readUsuario()) {
    ...
    private void deletarUsuario() {
        ...
        if (Acesso.verificarDeletarDadosUsuario()) {
            ...
            try {
                ...
                if (FrmSalvar.senha()) {
                    setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    u.setUser_id((Integer) tblUsuarios.getValueAt(tblUsuarios.getSelectedRow(), 0));
