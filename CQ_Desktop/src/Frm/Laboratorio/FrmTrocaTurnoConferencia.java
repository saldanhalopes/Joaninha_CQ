 ...
 * @author rafael.lopes
 */
public class FrmTrocaTurnoConferencia extends javax.swing.JDialog {
     ...
     * @param system_name
     */
    public FrmTrocaTurnoConferencia(java.awt.Frame parent, boolean modal,
            Integer turno_id, String responsavel, Boolean novo, Boolean salvar) {
        super(parent, modal);
        initComponents();
    ...
    private void btnImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirRelatorioActionPerformed
        ...
        if (dialogResult == 0) {
            MessageFormat header = createFormat("Turno Conferência: "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTrocaTurnoConferencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmTrocaTurnoConferencia dialog = new FrmTrocaTurnoConferencia(new javax.swing.JFrame(), true, null, null, false, false);
    ...
    private void carregarDados(int id) {
        ...
        turno.setTroca_turno_conferencia_id(id);
        TrocaTurnoConferenciaDAO turnoDao = new TrocaTurnoConferenciaDAO();
        turnoDao.selectTrocaTurnoConferencia(turno);
    ...
    private void criarTrocaTurno() {
        ...
        try {
            ...
            turnoDAO.createTrocaTurnoConferencia(turno);
        } catch (Exception e) {
    ...
    private void atulizarTrocaTurno() {
        ...
        try {
            Usuario user = new Usuario();
            turno.setTroca_turno_conferencia_id(troca_turno_id);
            turno.setTurno(cmbTurno.getSelectedItem().toString());
            turno.setDescricao_turno(txtDescricaoTurno.getText());
            turno.setData_registro(DataHora.getTimestampDate(new Date()));
            user.setUser(System.getProperty("user"));
            turno.setUser_name(user);
            turnoDAO.updateTrocaTurnoConferencia(turno);
        } catch (Exception e) {
    ...
    private void deletarTrocaTurno(int id) {
        ...
        try {
            ...
            if (dialogResult == 0) {
                turno.setTroca_turno_conferencia_id(id);
                turnoDAO.deleteTrocaTurnoConferencia(turno);
            }
        } catch (Exception e) {
