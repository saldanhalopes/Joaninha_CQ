...
public final class FrmColuna extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnGavetas = new javax.swing.JButton();
        ...
        pnlVerificacao = new javax.swing.JPanel();
        jLabel41 = new javax.swing.JLabel();
        txtDataVerificacao = new javax.swing.JTextField();
        btnDescarte1 = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        txtUsuarioVerificacao = new javax.swing.JTextField();
        btnUsuarioPerformance1 = new javax.swing.JButton();
        jLabel48 = new javax.swing.JLabel();
        jScrollPane3 = new javax.swing.JScrollPane();
        txtObsVerificacao = new javax.swing.JTextArea();
        ...
        btnEtiqueta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_barcode.png"))); // NOI18N
        ...
        btnGavetas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icon_arquivo.png"))); // NOI18N
        btnGavetas.setText("Vagas");
        btnGavetas.setFocusable(false);
        btnGavetas.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnGavetas.setPreferredSize(new java.awt.Dimension(60, 60));
        btnGavetas.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnGavetas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGavetasActionPerformed(evt);
            }
        });
        jToolBar1.add(btnGavetas);
        ...
        pnlColunaLayout.setHorizontalGroup(
            ...
            .addGroup(pnlColunaLayout.createSequentialGroup()
                .addGroup(pnlColunaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlColunaLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlColunaLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtPesquisarColuna, javax.swing.GroupLayout.DEFAULT_SIZE, 424, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel7.setPreferredSize(new java.awt.Dimension(1003, 700));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cmbMarca, 0, 281, Short.MAX_VALUE)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(cmbMetodo, 0, 254, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Descarte"));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnDescarte, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnRealocar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(14, 14, 14))
        );
        ...
        pnlVerificacao.setBorder(javax.swing.BorderFactory.createTitledBorder("Verificação"));

        jLabel41.setText("Verificado:");

        txtDataVerificacao.setEditable(false);
        txtDataVerificacao.setBackground(new java.awt.Color(204, 204, 204));

        btnDescarte1.setText("OK");
        ...
        txtUsuarioVerificacao.setEditable(false);
        txtUsuarioVerificacao.setBackground(new java.awt.Color(204, 204, 204));

        btnUsuarioPerformance1.setText("Usuário");
        btnUsuarioPerformance1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUsuarioPerformance1ActionPerformed(evt);
            }
        });

        jLabel48.setText("Obs:");

        txtObsVerificacao.setColumns(20);
        txtObsVerificacao.setRows(5);
        jScrollPane3.setViewportView(txtObsVerificacao);

        javax.swing.GroupLayout pnlVerificacaoLayout = new javax.swing.GroupLayout(pnlVerificacao);
        pnlVerificacao.setLayout(pnlVerificacaoLayout);
        pnlVerificacaoLayout.setHorizontalGroup(
            pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlVerificacaoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtDataVerificacao, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                    .addComponent(txtUsuarioVerificacao))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnUsuarioPerformance1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnDescarte1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        pnlVerificacaoLayout.setVerticalGroup(
            pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlVerificacaoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlVerificacaoLayout.createSequentialGroup()
                        .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel41)
                            .addComponent(txtDataVerificacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnDescarte1)
                            .addComponent(jLabel48))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlVerificacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtUsuarioVerificacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel8)
                            .addComponent(btnUsuarioPerformance1))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(pnlVerificacao, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(pnlVerificacao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(177, 177, 177))
        );
    ...
    private void btnUsuarioPerformance1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUsuarioPerformance1ActionPerformed
        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        List<Usuario> users = new ArrayList<>();
        FrmSelecionaUsuario frm = new FrmSelecionaUsuario(null, true, users);
        frm.setVisible(true);
        for (Usuario user : users) {
            txtUsuarioVerificacao.setText(user.getUser());
        }
        setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_btnUsuarioPerformance1ActionPerformed
    ...
    private void btnDescarte1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDescarte1ActionPerformed
        int dialogResult = JOptionPane.showConfirmDialog(null,
                "Deseja realizar a Verificação de Performance desta Coluna?", "Aviso", JOptionPane.YES_NO_OPTION);
        if (dialogResult == 0) {
            txtDataVerificacao.setText(DataHora.DateTimeNow());
        }
    ...
    private void btnRealocarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealocarActionPerformed
        int dialogResult = JOptionPane.showConfirmDialog(null,
                "Realmente Deseja Realocar Essa Coluna?", "Aviso", JOptionPane.YES_NO_OPTION);
        if (dialogResult == 0) {
            Coluna col = new Coluna();
            setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            FrmVagaColuna frm = new FrmVagaColuna(null, true, col);
            frm.setVisible(true);
            Integer[] vaga = {col.getVaga_coluna()};
            if (vaga[0] > 0) {
                realocarColuna(vaga[0]);
            }
            setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
        }
    ...
    private void btnPerformanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPerformanceActionPerformed
        int dialogResult = JOptionPane.showConfirmDialog(null,
                "Deseja realizar a Performance desta Coluna?", "Aviso", JOptionPane.YES_NO_OPTION);
        if (dialogResult == 0) {
    ...
    private void btnProcurarMetodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarMetodoActionPerformed
        ...
        txtVersao.setValue(mtd.getVersao());
    ...
    private void cmbMetodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMetodoActionPerformed
        if (cmbMetodo.getSelectedIndex() == 1) {
            ...
            txtObsColuna.setText("MULTIPROPÓSITO");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        } else if (txtVaga.getText().isEmpty() || ("0").equals(txtVaga.getText())) {
    ...
    private void btnGavetasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGavetasActionPerformed
        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        FrmVagaColuna frm = new FrmVagaColuna(null, true);
        frm.setVisible(true);
        setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
    }//GEN-LAST:event_btnGavetasActionPerformed
    ...
    public static javax.swing.JButton btnDescarte;
    ...
    public static javax.swing.JButton btnGavetas;
    ...
    public static javax.swing.JButton btnRealocar;
    ...
    private javax.swing.JButton btnUsuarioPerformance1;
    ...
    private javax.swing.JPanel pnlVerificacao;
    ...
    private javax.swing.JTextField txtDataVerificacao;
    private javax.swing.JTextField txtObsColuna;
    private javax.swing.JTextArea txtObsVerificacao;
    private javax.swing.JTextField txtPartNumber;
    private javax.swing.JTextField txtPesquisarColuna;
    private javax.swing.JTextField txtSerialNumber;
    private javax.swing.JTextField txtUsuarioDescarte;
    private javax.swing.JTextField txtUsuarioPerfermance;
    private javax.swing.JTextField txtUsuarioVerificacao;
    ...
    public final void readFinalidade() {
        ...
        for (Analise anls : anlsDao.readAnaliseFinalidade()) {
            Integer id = (Integer) anls.getAnalise_finalidade_id();
    ...
    private void limparCampos() {
        ...
        txtDataVerificacao.setText(null);
        txtUsuarioVerificacao.setText(null);
        txtObsVerificacao.setText(null);
    }
    ...
    private void criarColuna() {
        ...
        try {
            ...
            col.setData_performance(DataHora.getTimestampDateTime(txtDataPerformanceAtivacao.getText()));
            col.setData_descarte_coluna(DataHora.getTimestampDateTime(txtDataDescarte.getText()));
    ...
    private void fecharDados() {
        ...
        readColuna();
        setTitle("Colunas");
        pnlVerificacao.setVisible(false);
    }
    ...
    private void carregarDados(int id) {
        ...
        if (Acesso.verificarCarregarDadosColuna()) {
            ...
            readParticula();
            readFase();
            pnlVerificacao.setVisible(true);
            ...
            txtVersao.setValue(col.getMetodologia().getVersao());
            ...
            txtDataVerificacao.setText(DataHora.getStringDateTime(col.getData_verificacao()));
            txtUsuarioVerificacao.setText(col.getUser_verificacao().getUser());
            txtObsVerificacao.setText(col.getObs_verificacao());
    ...
    private void atulizarColuna() {
        ColunaAcesso Acesso = new ColunaAcesso();
        if (Acesso.verificarEditarDadosColuna()) {
            Coluna col = new Coluna();
            ColunaDAO colDAO = new ColunaDAO();
            try {
                Usuario user = new Usuario();
                ...
                col.setSerial_number_coluna(txtSerialNumber.getText().toUpperCase());
                col.setVaga_coluna(Integer.parseInt(txtVaga.getText()));
                col.setData_performance(txtDataPerformanceAtivacao.getText().isEmpty()
                        ? null : DataHora.getTimestampDate(txtDataPerformanceAtivacao.getText()));
                user.setUser(txtUsuarioPerfermance.getText());
                col.setUser_performance(user);
                col.setObs_coluna(txtObsColuna.getText().toUpperCase());
                user_verificacao.setUser(txtUsuarioVerificacao.getText());
                col.setUser_verificacao(user_verificacao);
                col.setObs_verificacao(txtObsVerificacao.getText());
                col.setData_verificacao(txtDataVerificacao.getText().isEmpty()
                        ? null : DataHora.getTimestampDateTime(txtDataVerificacao.getText()));
    ...
    private void descarteColuna() {
        ColunaAcesso Acesso = new ColunaAcesso();
        if (Acesso.verificarDescartarColuna()) {
            Coluna col = new Coluna();
            ColunaDAO colDAO = new ColunaDAO();
            try {
                Usuario user = new Usuario();
    ...
    private void realocarColuna(int vaga) {
        ColunaAcesso Acesso = new ColunaAcesso();
        if (Acesso.verificarDescartarColuna()) {
            Coluna col = new Coluna();
            ColunaDAO colDAO = new ColunaDAO();
            try {
                col.setColuna_id((Integer) tblColuna.getValueAt(tblColuna.getSelectedRow(), 0));
                col.setVaga_coluna(vaga);
                colDAO.updateRealocarColuna(col);
            } catch (NumberFormatException | HeadlessException e) {
                JOptionPane.showMessageDialog(null, "Erro ao atualizar dados: " + e);
            } finally {
                fecharDados();
