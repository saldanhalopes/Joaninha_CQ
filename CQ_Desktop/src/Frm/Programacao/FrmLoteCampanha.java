 ...
 * @author rafael.lopes
 */
public class FrmLoteCampanha extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmLoteCampanha(java.awt.Frame parent, boolean modal, List lote) {
        super(parent, modal);
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        tblLotes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Lote", "Método", "Material", "nome_material", "data_entrada"
            }
        ) {
        ...
        if (tblLotes.getColumnModel().getColumnCount() > 0) {
            ...
            tblLotes.getColumnModel().getColumn(3).setMaxWidth(80);
            tblLotes.getColumnModel().getColumn(4).setMinWidth(0);
            tblLotes.getColumnModel().getColumn(4).setPreferredWidth(0);
            tblLotes.getColumnModel().getColumn(4).setMaxWidth(0);
                    ...
                    for (int rowAnalises = 0; rowAnalises < rowsAnalises; rowAnalises++) {
                        if (tblAnalises.getValueAt(rowAnalises, 2) != null) {
                            if ((Boolean) tblAnalises.getValueAt(rowAnalises, 2)) {
                                ...
                                anls.setAnalise_id((Integer) tblAnalises.getValueAt(rowAnalises, 0));
                                anls.setAnalise(tblAnalises.getValueAt(rowAnalises, 1).toString());
                                Lote lot = new Lote();
                                lot.setLote_id((Integer) tblLotes.getValueAt(rowLotes, 0));
                                lot.setLote_produto(tblLotes.getValueAt(rowLotes, 1).toString());
                                lot.setData_entrada(DataHora.getTimestampDate(tblLotes.getValueAt(rowLotes, 5).toString()));
                                Metodologia mtd = new Metodologia();
                                mtd.setMetodo(tblLotes.getValueAt(rowLotes, 2).toString());
                                Material prd = new Material();
                                prd.setCod_material(tblLotes.getValueAt(rowLotes, 3).toString());
                                prd.setNome_material(tblLotes.getValueAt(rowLotes, 4).toString());
                                lot.setProduto(prd);
                                lot.setAnalise(anls);
                                lot.setMetodo(mtd);
                                lotes.add(lot);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLoteCampanha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmLoteCampanha dialog = new FrmLoteCampanha(new javax.swing.JFrame(), true, null);
