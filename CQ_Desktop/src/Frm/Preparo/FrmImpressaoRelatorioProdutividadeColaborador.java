 ...
 * @author rafael.lopes
 */
public class FrmImpressaoRelatorioProdutividadeColaborador extends javax.swing.JDialog {

    /**
     * Creates new form FrmImpressaoRelatorioRecepcao
     */
    public FrmImpressaoRelatorioProdutividadeColaborador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtDataInicio.getDate() == null) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null,
                    "Deseja Imprimir Relatorio de Produtividade Por Colaborador?", "Aviso", JOptionPane.YES_NO_OPTION);
            if (dialogResult == 0) {
                ...
                Thread t1 = new Thread() {
                    ...
                    public void run() {
                        ...
                        AtividadePreparoDAO.printProdutividadeColaborador(System.getProperty("user"), datahora_inicio, datahora_fim);
                        frm.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImpressaoRelatorioProdutividadeColaborador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmImpressaoRelatorioProdutividadeColaborador dialog = new FrmImpressaoRelatorioProdutividadeColaborador(new javax.swing.JFrame(), true);
