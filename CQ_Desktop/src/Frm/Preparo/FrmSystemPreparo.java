 ...
 * @author rafael.lopes
 */
public class FrmSystemPreparo extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmSystemPreparo(java.awt.Frame parent, boolean modal, int id, boolean pedido) {
        super(parent, modal);
        initComponents();
        setResizable(false);
    ...
    public FrmSystemPreparo(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
    ...
    public FrmSystemPreparo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("System Suitability"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSystemPreparo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmSystemPreparo dialog = new FrmSystemPreparo(new javax.swing.JFrame(), true);
    ...
    private void carregarDados(int id) {
        ...
        String[] tipo = {atvprep.getTipo_preparo()};
        cmbSolucao.setSelectedItem(tipo[0]);
        txtDescricao.setText(atvprep.getDescricao_preparo());
        txtNumeroSolucao.setValue(atvprep.getQtd_preparo().intValue());
        ...
        if (editar) {
            ...
            cmbSolucao.setEnabled(true);
            txtNumeroSolucao.setEnabled(true);
            txtUsuarioFim.setEnabled(true);
            btnUsuarioFim.setEnabled(true);
        } else {
            ...
            cmbSolucao.setEnabled(false);
            txtNumeroSolucao.setEnabled(false);
