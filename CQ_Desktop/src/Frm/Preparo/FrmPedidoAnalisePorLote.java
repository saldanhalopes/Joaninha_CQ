 ...
 * @author rafael.lopes
 */
public class FrmPedidoAnalisePorLote extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmPedidoAnalisePorLote(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
        setTitle("Pedido de Amostras");
        readMetodo();
        readAnalises();
        readEquipamento();
    }
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados Amostra"));
                    ...
                    for (int row = 0; row < rows; row++) {
                        if (tblAnalises.getValueAt(row, 2) != null) {
                            if ((Boolean) tblAnalises.getValueAt(row, 2)) {
                                ...
                                criarAnalise(user, (Integer) tblAnalises.getValueAt(row, 0));
    ...
    private void btnProcurarLoteAmostraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarLoteAmostraActionPerformed
        ...
        for (Lote lot : prds) {
            if (i == 0) {
                ...
                Integer[] mtd_id = {lot.getMetodo().getMetodo_id()};
                cmbMetodo.removeAllItems();
                cmbMetodo.addItem("");
                cmbMetodo.addItem("MULTIPROPÓSITO");
                categoryMapMetodo.clear();
                cmbMetodo.addItem(cod_mtd[0]);
                categoryMapMetodo.put(mtd_id[0], cod_mtd[0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPedidoAnalisePorLote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmPedidoAnalisePorLote dialog = new FrmPedidoAnalisePorLote(new javax.swing.JFrame(), true);
    ...
    private void criarAnalise(Usuario user, Integer analise_id) {
        try {
