 ...
 * @author rafael.lopes
 */
public class FrmImpressaoRelatorioProdutividadeGeral extends javax.swing.JDialog {

    /**
     * Creates new form FrmImpressaoRelatorioRecepcao
     */
    public FrmImpressaoRelatorioProdutividadeGeral(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtDataInicio.getDate() == null) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null,
                    "Deseja Imprimir Relatorio de Produtividade Geral?", "Aviso", JOptionPane.YES_NO_OPTION);
            if (dialogResult == 0) {
                ...
                Thread t1 = new Thread() {
                    ...
                    public void run() {
                        ...
                        AtividadePreparoDAO.printProdutividadeGeral(System.getProperty("user"), datahora_inicio, datahora_fim);
                        frm.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImpressaoRelatorioProdutividadeGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmImpressaoRelatorioProdutividadeGeral dialog = new FrmImpressaoRelatorioProdutividadeGeral(new javax.swing.JFrame(), true);
