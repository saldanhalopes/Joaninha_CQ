 ...
 * @author rafael.lopes
 */
public class FrmImpressaoRelatorioRetrabalho extends javax.swing.JDialog {

    /**
     * Creates new form FrmImpressaoRelatorioRecepcao
     */
    public FrmImpressaoRelatorioRetrabalho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtDataInicio.getDate() == null) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null,
                    "Deseja Imprimir Relatorio de Retrabalhos?", "Aviso", JOptionPane.YES_NO_OPTION);
            if (dialogResult == 0) {
                ...
                Thread t1 = new Thread() {
                    ...
                    public void run() {
                        ...
                        AtividadePreparoDAO.printRetrabalho(System.getProperty("user"), datahora_inicio, datahora_fim);
                        frm.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImpressaoRelatorioRetrabalho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmImpressaoRelatorioRetrabalho dialog = new FrmImpressaoRelatorioRetrabalho(new javax.swing.JFrame(), true);
