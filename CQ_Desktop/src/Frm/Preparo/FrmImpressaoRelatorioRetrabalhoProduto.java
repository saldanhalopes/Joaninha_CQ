 ...
 * @author rafael.lopes
 */
public class FrmImpressaoRelatorioRetrabalhoProduto extends javax.swing.JDialog {

    /**
     * Creates new form FrmImpressaoRelatorioRecepcao
     */
    public FrmImpressaoRelatorioRetrabalhoProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtDataInicio.getDate() == null) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null,
                    "Deseja Imprimir Relatorio de Retrabalhos por Produto?", "Aviso", JOptionPane.YES_NO_OPTION);
            if (dialogResult == 0) {
                ...
                Thread t1 = new Thread() {
                    ...
                    public void run() {
                        ...
                        AtividadePreparoDAO.printRetrabalhoProduto(System.getProperty("user"), datahora_inicio, datahora_fim);
                        frm.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImpressaoRelatorioRetrabalhoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmImpressaoRelatorioRetrabalhoProduto dialog = new FrmImpressaoRelatorioRetrabalhoProduto(new javax.swing.JFrame(), true);
