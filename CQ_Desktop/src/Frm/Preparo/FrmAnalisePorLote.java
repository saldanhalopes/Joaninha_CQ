 ...
 * @author rafael.lopes
 */
public class FrmAnalisePorLote extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmAnalisePorLote(java.awt.Frame parent, boolean modal, int id, boolean pedido) {
        super(parent, modal);
        initComponents();
        setResizable(false);
    ...
    public FrmAnalisePorLote(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
    ...
    public FrmAnalisePorLote(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        int rows = tblAnalises.getRowCount();
                ...
                if (txtLote.getText().isEmpty()) {
                    ...
                    for (int row = 0; row < rows; row++) {
                        if (tblAnalises.getValueAt(row, 2) != null) {
                            if ((Boolean) tblAnalises.getValueAt(row, 2)) {
                                setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                criarAtividade((Integer) tblAnalises.getValueAt(row, 0));
                                setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                            }
                        }
                    }
    ...
    private void btnProcurarLoteAmostraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcurarLoteAmostraActionPerformed
        ...
        for (Lote lot : prds) {
            if (i == 0) {
                ...
                readMetodo();
                String[] cod_mtd = {lot.getMetodo().getCod_metodo()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAnalisePorLote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmAnalisePorLote dialog = new FrmAnalisePorLote(new javax.swing.JFrame(), true);
    ...
    private void readAnalise(Analise anls) {
        DefaultTableModel model = (DefaultTableModel) tblAnalises.getModel();
        model.setNumRows(0);
        model.addRow(new Object[]{
            anls.getAnalise_id(),
    ...
    private void criarAtividade(int anls_id) {
        try {
            AtividadePreparo atvprep = new AtividadePreparo();
            AtividadePreparoDAO atvprepDAO = new AtividadePreparoDAO();
            Usuario user_regeistro = new Usuario();
    ...
    private void carregarDados(int id) {
        ...
        anls.setAnalise_id(atvprep.getAnalise().getAnalise_id());
        anls.setAnalise(atvprep.getAnalise().getAnalise());
        readAnalise(anls);
        ...
        if (editar) {
            ...
            btnProcurarLoteAmostra.setVisible(false);
