...
public class FrmTrocaTurno extends javax.swing.JDialog {
     ...
     * @param system_name
     */
    public FrmTrocaTurno(java.awt.Frame parent, boolean modal, String system_name,
            int campanha, String responsavel, int turno_id, boolean novo, boolean salvar) {
        super(parent, modal);
        initComponents();
        ...
        setTitle("Troca de Turno - " + system_name);
    ...
    public FrmTrocaTurno(java.awt.Frame parent, boolean modal, String system_name, int turno_id) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Troca de Turno - " + system_name);
    ...
    private void btnImprimirRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirRelatorioActionPerformed
        ...
        if (dialogResult == 0) {
            MessageFormat header = createFormat(sys_name + " - Passagem de Turno: "
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmTrocaTurno dialog = new FrmTrocaTurno(new javax.swing.JFrame(), true, null, 0, null, 0, false, false);
    ...
    private void criarTrocaTurno() {
        ...
        try {
            ...
            turnoDAO.createTrocaTurno(turno);
        } catch (Exception e) {
