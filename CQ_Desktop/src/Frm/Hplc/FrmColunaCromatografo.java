...
public class FrmColunaCromatografo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblColuna.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Coluna", "Método", "Ativação", "Localização", "Performance"
            }
        ) {
        ...
        if (tblColuna.getColumnModel().getColumnCount() > 0) {
            ...
            tblColuna.getColumnModel().getColumn(1).setPreferredWidth(350);
            tblColuna.getColumnModel().getColumn(3).setPreferredWidth(80);
            tblColuna.getColumnModel().getColumn(3).setMaxWidth(80);
            tblColuna.getColumnModel().getColumn(4).setPreferredWidth(150);
            tblColuna.getColumnModel().getColumn(4).setMaxWidth(150);
    ...
    public final void readColuna() {
        ...
        for (Coluna col : colDao.readColuna(setor, status)) {
            model.addRow(new Object[]{
                ...
                DataHora.getStringDate(col.getData_performance())
            });
        }
    }
    ...
    private void criarColunaCromatografo() {
        try {
            ...
            int id = colDAO.selectIDUltimaColunaBySystem(col);
            if (id > 0) {
                col.setLog_coluna_id(id);
            ...
            col.setData_inicio_log(DataHora.getTimestampDate(new Date()));
