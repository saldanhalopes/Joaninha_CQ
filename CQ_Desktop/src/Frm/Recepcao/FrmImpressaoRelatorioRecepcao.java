 ...
 * @author rafael.lopes
 */
public class FrmImpressaoRelatorioRecepcao extends javax.swing.JDialog {
     ...
     */
    public FrmImpressaoRelatorioRecepcao(java.awt.Frame parent, boolean modal, String finalidade) {
        super(parent, modal);
        initComponents();
        valor = finalidade;
        setTitle("Imprimir Relatório de Entrada de Lotes");
        setResizable(false);
        setLocationRelativeTo(null);
    }

    public FrmImpressaoRelatorioRecepcao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Imprimir Relatório de Entrada de Lotes");
        setResizable(false);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtDataInicio.getDate() == null) {
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null,
                    "Deseja Imprimir Relatorio de Lotes?", "Aviso", JOptionPane.YES_NO_OPTION);
            if (dialogResult == 0) {
                ...
                Thread t1 = new Thread() {
                    ...
                    public void run() {
                        ...
                        if (valor == null) {
                            LoteDAO.printEntradaLotes(System.getProperty("user"), datahora_inicio, datahora_fim);
                        } else {
                            LoteDAO.printEntradaLotes(System.getProperty("user"), datahora_inicio, datahora_fim, valor);
                        }
                        frm.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmImpressaoRelatorioRecepcao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmImpressaoRelatorioRecepcao dialog = new FrmImpressaoRelatorioRecepcao(new javax.swing.JFrame(), true, null);
