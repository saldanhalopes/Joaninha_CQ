...
import Classes.Acesso.EntradaProdutoEEPIG;
 ...
 * @author rafael.lopes
 */
public final class FrmEntradaEEPIG extends javax.swing.JInternalFrame {
     ...
     */
    public FrmEntradaEEPIG() {
        initComponents();
        setTitle("Entrada de EEPIG");
        loadHora();
        readCadastroLote();
        pnlCadastroProduto.setEnabledAt(1, false);
        EntradaProdutoEEPIG Acesso = new EntradaProdutoEEPIG();
    ...
    private void initComponents() {
        ...
        mnuEditarLoteEEPIG = new javax.swing.JMenu();
        ...
        mnuEditarLoteEEPIG.setText("Editar");
        ...
        mnuEditarLoteEEPIG.add(itmEditarLoteValidacaoLimpeza);
        ...
        mnuEditarLoteEEPIG.add(itmExcluirLoteValidacaoLimpeza);

        jMenuBar1.add(mnuEditarLoteEEPIG);
    ...
    private void btnImprimirLotesValidacaoLimpezaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirLotesValidacaoLimpezaActionPerformed
        FrmImpressaoRelatorioRecepcao frm = new FrmImpressaoRelatorioRecepcao(null, true, "= 5");
        frm.setVisible(true);
    ...
    public static javax.swing.JMenu mnuEditarLoteEEPIG;
    ...
    public final void readCadastroLote() {
        ...
        model.setNumRows(0);
        for (Lote lot : equipDao.readCadastroEEPIG(Integer.valueOf(cmbLimitPesquisarLotes.getSelectedItem().toString()))) {
    ...
    private void carregarDadosCadastroProduto(int id) {
        ...
        if (Acesso.verificarCarregarDados()) {
            ...
            mnuEditarLoteEEPIG.setEnabled(false);
    ...
    private void fecharDados() {
        ...
        mnuEditarLoteEEPIG.setEnabled(true);
        novoEntradaProduto = false;
        limparCampos();
        readCadastroLote();
        setTitle("Entrada de EEPIG");
    ...
    private void criarCadastroProduto() {
        ...
        if (Acesso.verificarCriarDados()) {
            ...
            try {
                ...
                alns.setAnalise_finalidade_id(5);
                lot.setProduto(prod);
                lot.setAnalise(alns);
                lot.setMetodo(mtd);
